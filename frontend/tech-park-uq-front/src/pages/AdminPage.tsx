      ...
      <main className="bg-black min-h-screen p-8">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="mt-4 text-zinc-400">
            Aquí podrás gestionar zonas, atracciones, operadores y ver reportes generales del parque.
          </p>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            ...
            <article className="rounded-3xl border border-zinc-800 bg-zinc-950 p-6">
              ...
              <p className="mt-2 text-zinc-400">Registra operadores y asígnalos a zonas específicas.</p>
            </article>
